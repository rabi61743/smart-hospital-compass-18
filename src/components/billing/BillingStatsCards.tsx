...
import { DollarSign, FileText, CreditCard, TrendingUp, Users, Clock } from "lucide-react";
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4 mb-8">
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-orange-600">148 pending invoices</p>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-blue-600">87% approval rate</p>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-green-600">+8.2% vs yesterday</p>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-blue-600">with pending bills</p>
        </CardContent>
      </Card>
