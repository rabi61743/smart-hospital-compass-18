    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{filteredModuleAdmins.length}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {currentDepartment?.modules.length || 0}
            </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {currentDepartment?.modules.filter(m => m.critical).length || 0}
            </div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-4">
            {filteredModuleAdmins.map((admin) => (
        ...
        <CardContent>
          <div className="overflow-x-auto">
            <table className="w-full border-collapse">
              ...
              <tbody>
                {currentDepartment?.modules.map((module, index) => {
                  const moduleAdmin = filteredModuleAdmins.find(admin => 
